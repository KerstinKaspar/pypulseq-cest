...
from sim_pulseq_sbb.eval import get_offsets
from sim_pulseq_sbb.util import get_noise_params
...
class Phantom():
    ...
    def set_t1(self, f_tissue: (str, None) = 'wm', noise_tissue: (str, None) = 'wm') -> np.array:
        """
        creates a fig for the stated tissue types (gm: gray matter, wm: white matter and csf: cerebrospinal fluid)
