...
# Run the simulateions with:
sim = simulate(config_file=sim_config, seq_file=seq_file, show_plot=False)

# If you need additional processing, you can access the functions directly from the simulation object.
# For example, you can retrieve the magnetization vector with:
m_out = sim.GetFinalMagnetizationVectors()

# To get the correct magnetization in z-direction, you can use:
